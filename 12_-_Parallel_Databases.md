...
**intra-query parallelism**: 
	- **intra-operator (horizontal, JOINs)**: 
		- operators decomposed into independent operators instances, 
		  which perform the same operation on different subsets of data
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwMDA5MjkwMywxNjAzNjIwMDY5LDc1OT
